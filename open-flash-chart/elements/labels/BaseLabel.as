  ...
  import flash.text.TextFieldType;
	...
	public class BaseLabel extends Sprite {
      ...
      title.x = 0;
			...
			this.build_from_field(title);
		}
		
		public function build_from_field(title:TextField):void {
			...
			fmt.size = this.css.font_size ? this.css.font_size : 12;
			fmt.align = "center";
...
//			title.border = true;
			...
			// Create a bitmap child to enable rotation without embedded fonts.
			if (title.rotation != 0)
